...
# The graph title
<<<<<<< HEAD:benchmark/noconcurrencydots.p
...
>>>>>>> Modify sendResponse to send large files:benchmark/before/noconcurrencydots.p
...
# Plot the data
plot "benchmark/noconcurrency.tsv" every ::2 using 2:5 title 'response time' with points
exit